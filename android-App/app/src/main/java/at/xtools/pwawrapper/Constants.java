...
public class Constants {
    public Constants(){}
    // Root page
    public static String WEBAPP_URL = "https://www.adamaoki.ml/";
    public static String WEBAPP_HOST = "adamaoki.ml"; // used for checking Intent-URLs
    ...
    public static int PROGRESS_THRESHOLD = 99;
